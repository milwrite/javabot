...
### featured (6 pages)
- **amtrak-journey.html** - Zach & Cen's Amtrak Journey
  - *Rail trip arcade story*
...
- **dermpath-tetris.html** - DermaPath Tetris
  ...
  - Size: 24KB | Modified: 2025-12-15
- **dmv-maze.html** - DMV Maze of Despair
  - *bureaucratic nightmare simulator*
  - Size: 20KB | Modified: 2025-12-15
- **foot-scratch-game.html** - Foot Scratch Simulator
  - *absurd itch relief arcade*
...
- **pleasantville-crossword.html** - Pleasantville Crossword
  ...
  - Size: 19KB | Modified: 2025-12-15
- **rhythm-test.html** - Rhythm Test
  - *beat matching rhythm arcade*
  - Size: 16KB | Modified: 2025-12-18
...
- **snake-retriever.html** - Snake Retriever
  ...
  - Size: 24KB | Modified: 2025-12-15
- **snaker.html** - Snaker
  - *Endless neon snake run*
  - Size: 17KB | Modified: 2025-12-15
- **space-invaders.html** - AI vs Human Invaders
  - *Kaboom duel defense wave*
  - Size: 8KB | Modified: 2025-12-15
- **sudoku.html** - Sudoku
  - *Grid logic puzzle board*
...
### utilities-apps (17 pages)
- **cen-schedule.html** - Cen's Day Planner
  - *branching daily schedule explorer*
  - Size: 23KB | Modified: 2025-12-15
- **cen-sunday-todo.html** - Cen Sunday Todo
  - *Weekend chore battle plan*
  - Size: 6KB | Modified: 2025-12-15
- **cen-todo-list.html** - Cen Todo Console
  - *Daily tasks tracker*
  - Size: 8KB | Modified: 2025-12-15
- **friday-wheel.html** - Friday Night Wheel
  - *spinning activity decision maker*
...
- **riddle-river.html** - The River Riddle
  - *scroll-reveal riddle utility*
  - Size: 17KB | Modified: 2025-12-18
...
- **sunday-wheel.html** - Sunday Spin
  - *weekend activity spinner wheel*
...
- **borscht.html** - Borscht Recipe
  ...
  - Size: 17KB | Modified: 2025-12-15
- **bushwick.html** - Bushwick Field Guide
  - *Neighborhood missions explorer*
  - Size: 8KB | Modified: 2025-12-15
- **cen_veggie_haul.html** - Cen's Veggie Haul
  - *Farmers market inventory log*
  - Size: 15KB | Modified: 2025-12-15
- **coffee-steam-viz.html** - Coffee in Snow
  - *cozy particle coffee ritual*
  - Size: 15KB | Modified: 2025-12-15
- **digital_sisyphus.html** - Digital Sisyphus Loop
  - *Absurdist scroll meditation*
  - Size: 19KB | Modified: 2025-12-15
...
- **letter-to-nancy.html** - Letter to Nancy
  ...
  - Size: 20KB | Modified: 2025-12-15
- **radish_love.html** - Radish Love Letter
  - *Playful ode to roots*
  - Size: 7KB | Modified: 2025-12-15
- **red-siren-protocol.html** - Red Siren Protocol
  - *Emergency alert hub*
  - Size: 19KB | Modified: 2025-12-15
...
- **ai-agency-flier.js** - 18KB (2025-12-15)
- **amtrak-games.js** - 30KB (2025-12-15)
- **arcade-joystick.js** - 18KB (2025-12-15)
- **bills_qb_game.js** - 18KB (2025-12-15)
- **bubba_clicker.js** - 18KB (2025-12-15)
- **bushwick.js** - 4KB (2025-12-15)
- **dermpath-tetris.js** - 12KB (2025-12-15)
- **dmv-maze.js** - 13KB (2025-12-15)
- **example.js** - 2KB (2025-12-15)
- **frog_whack_a_mole.js** - 7KB (2025-12-15)
- **frogger.js** - 13KB (2025-12-15)
- **leaflet.js** - 6KB (2025-12-15)
- **parlay_probability_viz.js** - 11KB (2025-12-15)
- **pigman.js** - 29KB (2025-12-15)
- **space-invaders.js** - 23KB (2025-12-15)
- **sudoku.js** - 11KB (2025-12-15)
...
│   ├── zach_work_schedule.html   # Zach Work Schedule
│   ├── zach-errands.html         # Zach Errands
│   ├── ai-agency-flier.js        # JavaScript library
│   ├── amtrak-games.js           # JavaScript library
│   ├── arcade-joystick.js        # JavaScript library
│   ├── bills_qb_game.js          # JavaScript library
│   ├── bubba_clicker.js          # JavaScript library
│   ├── bushwick.js               # JavaScript library
│   ├── dermpath-tetris.js        # JavaScript library
│   ├── dmv-maze.js               # JavaScript library
│   ├── example.js                # JavaScript library
│   ├── frog_whack_a_mole.js      # JavaScript library
│   ├── frogger.js                # JavaScript library
│   ├── leaflet.js                # JavaScript library
│   ├── parlay_probability_viz.js # JavaScript library
│   ├── pigman.js                 # JavaScript library
│   ├── space-invaders.js         # JavaScript library
│   ├── sudoku.js                 # JavaScript library
...
### Featured Content
- [Zach & Cen's Amtrak Journey](https://milwrite.github.io/javabot/src/amtrak-journey.html)
- [Anniversary Chronicle](https://milwrite.github.io/javabot/src/anniversary.html)
- [Double Dragon Beatdown](https://milwrite.github.io/javabot/src/double_dragon_beatem_up.html)
- [Pigman Maze Run](https://milwrite.github.io/javabot/src/pigman.html)
- [Rat Bushwick Log](https://milwrite.github.io/javabot/src/rat_bushwick.html)
- [Terminal Memory](https://milwrite.github.io/javabot/src/terminal-memory.html)

### Games  
- [Basket Jam](https://milwrite.github.io/javabot/src/basket-jam.html)
- [Bills QB Challenge](https://milwrite.github.io/javabot/src/bills_qb_game.html)
- [Bubba Clicker](https://milwrite.github.io/javabot/src/bubba_clicker.html)
- [DermaPath Tetris](https://milwrite.github.io/javabot/src/dermpath-tetris.html)
- [DMV Maze of Despair](https://milwrite.github.io/javabot/src/dmv-maze.html)
- [Foot Scratch Simulator](https://milwrite.github.io/javabot/src/foot-scratch-game.html)
- [Frog Whack-a-Mole](https://milwrite.github.io/javabot/src/frog_whack_a_mole.html)
...
- [Rhythm Test](https://milwrite.github.io/javabot/src/rhythm-test.html)
...
- [Sudoku](https://milwrite.github.io/javabot/src/sudoku.html)
- [Tic-Tac-Toe Confetti](https://milwrite.github.io/javabot/src/tictactoe-confetti.html)

### Utilities
- [Cen's Day Planner](https://milwrite.github.io/javabot/src/cen-schedule.html)
- [Cen Sunday Todo](https://milwrite.github.io/javabot/src/cen-sunday-todo.html)
- [Cen Todo Console](https://milwrite.github.io/javabot/src/cen-todo-list.html)
- [Friday Night Wheel](https://milwrite.github.io/javabot/src/friday-wheel.html)
- [Legacy Index](https://milwrite.github.io/javabot/src/index.html)
- [Noodle Inventory](https://milwrite.github.io/javabot/src/noodle_inventory.html)
...
- [The River Riddle](https://milwrite.github.io/javabot/src/riddle-river.html)
...
- [Weekend Planner](https://milwrite.github.io/javabot/src/weekend planner.html)
- [Zach Work Schedule](https://milwrite.github.io/javabot/src/zach_work_schedule.html)
- [Zach Errands](https://milwrite.github.io/javabot/src/zach-errands.html)
